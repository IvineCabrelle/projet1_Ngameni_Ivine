    ...
    <div class="container-fluid">ac
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="../gestionDeProduits/ModifierProduits.php">modifier produits</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../gestionDeProduits/SupprimerProduit.php/">Supprimer vos produits</a>
          </li>
