    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="../gestion de produits/ModifierProduits.php">modifier produits</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../gestion de produits/SupprimerProduit.php/">Supprimer vos produits</a>
          </li>
